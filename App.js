...
function App() {
    ...
    React.useEffect(() => {
        refTimer.current = setInterval(() => {
            ...
            const gifBoxImage = document.createElement("img");
            gifBoxImage.src = giftBoxImage; // Sử dụng biến import trực tiếp
            gifBoxImage.alt = "Gift Box";
            gifBoxImage.className = "gift-box__image";
            ...
            gifBoxImage.style.width = "100%";
            gifBoxImage.style.height = "100%";
            gifBoxImage.style.objectFit = "contain";
            // Thêm bóng hồng cho ảnh
            gifBoxImage.style.filter =
                "drop-shadow(0 0 8px #ff69b4) drop-shadow(0 0 24px #ff69b4cc)";

            giftBox.appendChild(gifBoxImage);
